...
| ------- | -------------- | -------------- | ----------- | ----------- |
| [composer](https://getcomposer.org/) | ![composer](https://img.shields.io/badge/composer-1.1.3-green.svg) | [![Docker Version)](https://img.shields.io/docker/v/gearboxworks/composer/1.1.3)](https://hub.docker.com/repository/docker/gearboxworks/composer) | [![Docker Size](https://img.shields.io/docker/image-size/gearboxworks/composer/1.1.3)](https://hub.docker.com/repository/docker/gearboxworks/composer) | _([`1.1.3`, `1.1`](https://github.com/gearboxworks/docker-composer/blob/master/versions/1.1.3/DockerfileRuntime))_ |
| [composer](https://getcomposer.org/) | ![composer](https://img.shields.io/badge/composer-1.10.0-green.svg) | [![Docker Version)](https://img.shields.io/docker/v/gearboxworks/composer/1.10.0)](https://hub.docker.com/repository/docker/gearboxworks/composer) | [![Docker Size](https://img.shields.io/docker/image-size/gearboxworks/composer/1.10.0)](https://hub.docker.com/repository/docker/gearboxworks/composer) | _([`1.10.0`, `1.10`, `latest`](https://github.com/gearboxworks/docker-composer/blob/master/versions/1.10.0/DockerfileRuntime))_ |
| [composer](https://getcomposer.org/) | ![composer](https://img.shields.io/badge/composer-1.2.4-green.svg) | [![Docker Version)](https://img.shields.io/docker/v/gearboxworks/composer/1.2.4)](https://hub.docker.com/repository/docker/gearboxworks/composer) | [![Docker Size](https://img.shields.io/docker/image-size/gearboxworks/composer/1.2.4)](https://hub.docker.com/repository/docker/gearboxworks/composer) | _([`1.2.4`, `1.2`](https://github.com/gearboxworks/docker-composer/blob/master/versions/1.2.4/DockerfileRuntime))_ |
| [composer](https://getcomposer.org/) | ![composer](https://img.shields.io/badge/composer-1.3.3-green.svg) | [![Docker Version)](https://img.shields.io/docker/v/gearboxworks/composer/1.3.3)](https://hub.docker.com/repository/docker/gearboxworks/composer) | [![Docker Size](https://img.shields.io/docker/image-size/gearboxworks/composer/1.3.3)](https://hub.docker.com/repository/docker/gearboxworks/composer) | _([`1.3.3`, `1.3`](https://github.com/gearboxworks/docker-composer/blob/master/versions/1.3.3/DockerfileRuntime))_ |
| [composer](https://getcomposer.org/) | ![composer](https://img.shields.io/badge/composer-1.4.3-green.svg) | [![Docker Version)](https://img.shields.io/docker/v/gearboxworks/composer/1.4.3)](https://hub.docker.com/repository/docker/gearboxworks/composer) | [![Docker Size](https://img.shields.io/docker/image-size/gearboxworks/composer/1.4.3)](https://hub.docker.com/repository/docker/gearboxworks/composer) | _([`1.4.3`, `1.4`](https://github.com/gearboxworks/docker-composer/blob/master/versions/1.4.3/DockerfileRuntime))_ |
| [composer](https://getcomposer.org/) | ![composer](https://img.shields.io/badge/composer-1.5.6-green.svg) | [![Docker Version)](https://img.shields.io/docker/v/gearboxworks/composer/1.5.6)](https://hub.docker.com/repository/docker/gearboxworks/composer) | [![Docker Size](https://img.shields.io/docker/image-size/gearboxworks/composer/1.5.6)](https://hub.docker.com/repository/docker/gearboxworks/composer) | _([`1.5.6`, `1.5`](https://github.com/gearboxworks/docker-composer/blob/master/versions/1.5.6/DockerfileRuntime))_ |
| [composer](https://getcomposer.org/) | ![composer](https://img.shields.io/badge/composer-1.6.5-green.svg) | [![Docker Version)](https://img.shields.io/docker/v/gearboxworks/composer/1.6.5)](https://hub.docker.com/repository/docker/gearboxworks/composer) | [![Docker Size](https://img.shields.io/docker/image-size/gearboxworks/composer/1.6.5)](https://hub.docker.com/repository/docker/gearboxworks/composer) | _([`1.6.5`, `1.6`](https://github.com/gearboxworks/docker-composer/blob/master/versions/1.6.5/DockerfileRuntime))_ |
| [composer](https://getcomposer.org/) | ![composer](https://img.shields.io/badge/composer-1.7.3-green.svg) | [![Docker Version)](https://img.shields.io/docker/v/gearboxworks/composer/1.7.3)](https://hub.docker.com/repository/docker/gearboxworks/composer) | [![Docker Size](https://img.shields.io/docker/image-size/gearboxworks/composer/1.7.3)](https://hub.docker.com/repository/docker/gearboxworks/composer) | _([`1.7.3`, `1.7`](https://github.com/gearboxworks/docker-composer/blob/master/versions/1.7.3/DockerfileRuntime))_ |
| [composer](https://getcomposer.org/) | ![composer](https://img.shields.io/badge/composer-1.8.6-green.svg) | [![Docker Version)](https://img.shields.io/docker/v/gearboxworks/composer/1.8.6)](https://hub.docker.com/repository/docker/gearboxworks/composer) | [![Docker Size](https://img.shields.io/docker/image-size/gearboxworks/composer/1.8.6)](https://hub.docker.com/repository/docker/gearboxworks/composer) | _([`1.8.6`, `1.8`](https://github.com/gearboxworks/docker-composer/blob/master/versions/1.8.6/DockerfileRuntime))_ |
| [composer](https://getcomposer.org/) | ![composer](https://img.shields.io/badge/composer-1.9.3-green.svg) | [![Docker Version)](https://img.shields.io/docker/v/gearboxworks/composer/1.9.3)](https://hub.docker.com/repository/docker/gearboxworks/composer) | [![Docker Size](https://img.shields.io/docker/image-size/gearboxworks/composer/1.9.3)](https://hub.docker.com/repository/docker/gearboxworks/composer) | _([`1.9.3`, `1.9`](https://github.com/gearboxworks/docker-composer/blob/master/versions/1.9.3/DockerfileRuntime))_ |
...
`./bin/gb-launch -gb-name composer`

Create, and start the composer Gearbox container. Run a shell.

`./bin/gb-launch -gb-name composer -gb-shell`

Create, and start the composer Gearbox container with version 1.2.4 and run a shell.

`./bin/gb-launch -gb-name composer -gb-version 1.2.4 -gb-shell`
...
`./bin/gb-launch -gb-name composer -gb-version 1.2.4 -flag1 -flag2 variable`
...
`./bin/gb-launch -gb-name composer -gb-version 1.2.4 -gb-shell -- ls -l`

`./bin/composer -gb-shell -- ps -eaf`

`./bin/gb-launch -gb-name composer -gb-version 1.2.4 -gb-shell -- ps -eaf`


ssh - All [Gearbox](https://github.com/gearboxworks/) containers have a running SSH daemon. So you can connect remotely.
To show what ports are exported to the host.

`./bin/gb-launch -gb-name composer -gb-list`
