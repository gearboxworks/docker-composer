...
`./launch shell composer:1.2.4`

`./launch shell composer:1.2.4 ls -l`

`./launch shell composer:1.2.4 ps -eaf`
...
`./launch composer:1.2.4 -flag1 -flag2 variable`
...
- `composer` - will execute `composer` within the container.
